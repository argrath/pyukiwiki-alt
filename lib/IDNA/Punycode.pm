#$Id: Punycode.pm,v 1.37 2006/09/29 09:11:32 papu Exp $
...
Tatsuhiko Miyagawa E<lt>miyagawa (at) bulknews (dot) netE<gt> is the original
author and wrote almost all the code.

Robert Urban E<lt>urban (at) UNIX-Beratung (dot) deE<gt> added C<idn_prefix()>.
