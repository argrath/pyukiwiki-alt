...
# $Id: Jcode.pm,v 1.51 2006/09/29 09:11:31 papu Exp $
...
$RCSID = q$Id: Jcode.pm,v 1.51 2006/09/29 09:11:31 papu Exp $;
...
And folks at Jcode Mailing list <jcode5 (at) ring (dot) gr (dot) jp>.  Without them, I
...
Copyright 1999-2005 Dan Kogai <dankogai (at) dan (dot) co (dot) jp>
